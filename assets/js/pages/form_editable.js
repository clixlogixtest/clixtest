...
$(function() {
    ...
    $.mockjax({
        ...
        response: function(settings) {
            this.responseText = [ 
                {value: 0, text: 'Type School 1'},
                {value: 1, text: 'Type School 2'},
                {value: 2, text: 'Type School 3'},
                {value: 3, text: 'Type School 4'},
                {value: 4, text: 'Type School 5'},
                {value: 5, text: 'High School'}
            ];
            log(settings, this);
        }        
    });
