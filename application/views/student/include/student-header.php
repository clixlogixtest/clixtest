	...
	<div class="navbar navbar-inverse bg-primary  navbar-fixed-top">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo site_url('student-dashboard');?>">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav middle-menu">
				...
				<li class="nav-item">
					<a href="<?php echo site_url('search-teacher');?>">FIND TEACHER </a>
				</li>
				<li class="nav-item">
					<a href="">THIS IS HOW IT WORKS</a>
				</li>
				<li class="nav-item">
					<a href="">PRICES</a>
				</li>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown dropdown-user mobile_hide hide_mobile">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<?php if (!empty($user_details['image_url'])) { ?>
                        <img src="<?php echo base_url();?>assets/upload/user/<?php echo $user_details['image_url'];?>">
                        <?php } else{ ?>
